...
final class Workspace: Identifiable, ObservableObject {
    ...
    func recoverRemoteOnUserActivation(reason: String) -> Bool {
        ...
        if remoteConnectionState == .error || remoteDaemonStatus.state == .error || hasProxyOnlyRemoteSidebarError {
#if DEBUG
            cmuxDebugLog(
